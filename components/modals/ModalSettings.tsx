  ...
  let modal = (
    <>
      ...
      <>
        {/* Modal */}
        <div
          className="absolute right-10 top-11 z-30 mt-1 flex w-fit flex-col gap-2 rounded-lg bg-neutral-300 p-4 px-6 shadow-md dark:bg-neutral-600 max-[350px]:right-1 max-[350px]:w-[95%]
       max-[350px]:p-1 max-[350px]:text-base xl:px-10 2xl:right-[2.7rem]"
        >
          {content}
        </div>
      </>
