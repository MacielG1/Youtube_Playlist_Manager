...
//         <div
//           className={`relative overflow-hidden group w-60 xs:w-52 md:w-56 lg:w-64 xl:w-[17.8rem] 3xl:w-80 rounded-xl    ${
//             isDragging ? "cursor-grabbing" : "cursor-pointer"
//           }`}
//         >
//           <button
//             onClick={openModal}
//             className="opacity-0 group-hover:opacity-100 z-10 peer absolute bg-neutral-800 text-neutral-40 hover:text-red-500 top-0 right-0 p-1 hover:bg-neutral-900 group-hover:transition-opacity group-hover:duration-500 rounded-bl-md"
