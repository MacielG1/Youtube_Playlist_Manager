  ...
  ({ className, ...props }, ref) => (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          `dark:data-[state=unchecked]:bg-slate-700 pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 data-[state=checked]:bg-black data-[state=unchecked]:bg-neutral-700`,
        )}
      />
    </SwitchPrimitives.Root>
  ),
